    ...
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          return (
            <TouchableOpacity onPress={() => navigation.navigate('AddEditYieldPocket', { walletId: item.walletId })}>
              <GlassCard style={styles.card}>
                <View style={styles.cardHeader}>
                  ...
                  <Text style={styles.rateText}>{item.annualYieldRate}% APY</Text>
                </View>
                ...
                <View style={styles.detailsRow}>
                  ...
                  <View style={styles.detailItem}>
                    ...
                    <Text style={[styles.detailValue, { textTransform: 'capitalize' }]}>{item.yieldFrequency}</Text>
                  </View>
                </View>
                ...
                {item.nextYieldDate && (
                  <View style={styles.footerRow}>
                    ...
                    <Text style={styles.footerText}>
                      Next yield: {new Date(item.nextYieldDate).toLocaleDateString()}
                    </Text>
                  </View>
                )}
              </GlassCard>
